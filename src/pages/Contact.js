...
function Contact(props) {
    ...
    const onConfirm = async () => {
        setLoading(true);
        try {
            await ky.post("https://arc-development-alpha.vercel.app/api/sendmail").json({
                name: name,
                email: email,
                phone: phone,
                message: message,
    ...
    const buttonContents = (
        <React.Fragment>
            Send Message
            <img src={airplane} alt="paper airplane" style={{ marginLeft: "0.5em" }} />
        </React.Fragment>
    );
